...
; Main file for Mecrisp for MSP430G2533.
...
RamAnfang   equ   200h ; Start of RAM
RamEnde     equ   400h ; End of RAM, 512 Bytes
FlashAnfang equ 0C000h ; Start of Flash, 16 kb, Flash end always is $FFFF.
...
;------------------------------------------------------------------------------
  ...
  welcome " for MSP430G2533 by Matthias Koch"
...
;------------------------------------------------------------------------------
 ...
 org 0FFE0h ; Interrupt table with hooks
  ...
  .word   null_handler         ; 12: 0FFF6  Comparator. Unused
