...
; Main file for Mecrisp for MSP430F5510.
...
RamEnde     equ 3400h ; End of RAM, 8 kb
FlashAnfang equ 8000h ; Start of Flash, 32 kb, Flash end always is $FFFF.
...
- mov.w #0h, &16Eh
  ...
  welcome " for MSP430F5510 by Matthias Koch"
